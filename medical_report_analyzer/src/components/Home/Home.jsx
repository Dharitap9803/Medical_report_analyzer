...
import HeroImg from '../../assets/MAIN.jpg'; // Adjust the path as per your folder structure
...
const Home = () => {
  ...
  <div className="container-xl">
    ...
    <div className="row g-3 d-flex justify-content-center">
      ...
      <div className="col-lg-4 col-md-4 col-sm-6 col-12">
        <div className="card">
          ...
          <div className="content">
            ...
            <p className="text">Receive personalized guidance from healthcare experts.</p>
          </div>
        </div>
      </div>
      ...
      <section className="call-to-action" id="get-started">
        <h2>Ready to Improve Your Health?</h2>
        <Link to="/ReportAnalyzer" className="cta-button">
          Upload Your Report
        </Link>
      </section>
      ...
      <footer className="footer" id="contact">
        <p>© 2024 HealthAnalyzer. All Rights Reserved.</p>
        <p>Contact us at support@healthanalyzer.com</p>
      </footer>
    </div>
  );
};
